...
The full worldview as a drop-in system prompt: how a retiring senior staff engineer plans, designs, organizes, and verifies work. Use with any capable model, in a chat UI or an agent harness, with or without tool access. The task prompts in this repo each carry the slice of this they need — stack this underneath them when your tool has a system prompt slot.

**Use as:** system prompt. Your actual task goes in the user message.
