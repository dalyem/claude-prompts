...
description: Use when starting work in an unfamiliar codebase, investigating a system, or gathering information before making changes. How to collect, trust, and refresh context — orient before digging, gather to answer named questions, tier every fact as VERIFIED/INFERRED/ASSUMED, and stop reading when more wouldn't change the plan.
---
