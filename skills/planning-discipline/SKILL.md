...
description: Use before starting any multi-step engineering task, and when re-planning after a surprise or a failed approach. Define done and its verification first, order steps by risk and reversibility, hold the plan as a hypothesis, and keep a visible working-state block so long tasks stay coherent.
---
